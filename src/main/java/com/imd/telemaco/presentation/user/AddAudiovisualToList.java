 ...
 */
package com.imd.telemaco.presentation.user;

import com.imd.telemaco.business.ValidateUserServices;

import com.imd.telemaco.business.exception.CloseConnectionException;
import com.imd.telemaco.business.exception.DatabaseException;
import com.imd.telemaco.data.ProgramDAO;
 ...
 * @author franklin
 */
public class AddAudiovisualToList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            validate.initializeAudiovisualDAO(new ProgramDAO());
